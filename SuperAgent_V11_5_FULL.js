/* SuperAgent V11.5 FULL — hardening over V11.4; Google Lite-priority 3-model chain; no AI router. */
/* SuperAgent V11.4 FULL — Google-only stable 3-model chain: Gemini 3.5 Flash-Lite primary, Gemini 3.1 Flash-Lite fallback 1, Gemini Flash-Lite Latest fallback 2. V11.3 reliability hardening retained; AI router remains removed. */
...
{short:"G3.1-L",name:"Gemini 3.1 Flash-Lite",id:"gemini::gemini-3.1-flash-lite",timeoutMs:4500,role:"fallback_1",tags:["chat","shopping","schedule","json","arabic"]},
{short:"GL-Latest",name:"Gemini Flash-Lite Latest",id:"gemini::gemini-flash-lite-latest",timeoutMs:4500,role:"fallback_2",tags:["chat","shopping","schedule","coding","json","arabic"]}
];
...
push("v114_fallback2_is_gemini36_flash",FALLBACK_MODELS[1]?.id==="gemini::gemini-flash-lite-latest",FALLBACK_MODELS[1]?.id||"");
...
// Versioned identity.
handleV11Identity=async function(text,env,chatId){if(!isV11IdentityQuestion(text))return false;await sendText(env,chatId,'أنا سوبر إيجنت V11.5 🤖 — مساعدك الشخصي لتنظيم يومك ومواعيدك ومشترياتك وذاكرتك ومهامك من الكلام الطبيعي.');return true;};
...
function runV114PureSelfTests(){
  ...
  add('v114 fallback2 Gemini Flash-Lite Latest',ids[2]==='gemini::gemini-flash-lite-latest',ids[2]||'');
