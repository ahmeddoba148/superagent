...
const V10_VERSION="11.1.0";const V10_NAME="سوبر إيجنت V11.1 — سريع وسلس ومتعدد النماذج";const RELIABILITY_RECEIPT_TTL_MINUTES=10;const RUNTIME_FAILURE_RETENTION_DAYS=30;const VOICE_MAX_BYTES=25*1024*1024;const V10_AUDIT_LIMIT=100;const V10_WORLD_CONTEXT_LIMIT=50;const V10_MAX_SHOP_ITEMS=80;const TIME_ZONE="Africa/Cairo";const PENDING_TTL_MINUTES=30;const CONFLICT_TTL_MINUTES=20;const TOTAL_AI_BUDGET_MS=12000;const V11_ROUTER_BUDGET_MS=1100;const V11_ROUTE_LOCAL_CONFIDENCE=0.90;const V11_MIN_ROUTE_CONFIDENCE=0.55;const V111_EASY_PLAN_BUDGET_MS=6000;const V111_COMPLEX_PLAN_BUDGET_MS=11500;const V111_HEDGE_DELAY_MS=120;const AI_RATE_LIMIT_PER_MINUTE=15;const CONVERSATION_MEMORY_LIMIT=24;const CONTEXT_DAYS=365;const CONTEXT_NEAR_LIMIT=160;const CONTEXT_RELEVANT_LIMIT=80;const CONTEXT_RULE_LIMIT=120;const FREE_PERIOD_HORIZON_DAYS=180;const FREE_SLOT_HORIZON_DAYS=60;const CONFLICT_LOOKAHEAD_DAYS=60;const MAX_RULE_OCCURRENCES=5000;const SCHEDULER_MAX_CATCHUP_MINUTES=1440;const MAX_ADVANCE_ALERT_MINUTES=10080;const SHOW_MODEL_USED_TO_ADMIN=false;const LIVE_NEWS_MAX=8;const LIVE_NEWS_TTL_MINUTES=5;const LIVE_WATCH_BATCH_SIZE=8;const PRAYER_CACHE_TTL_MINUTES=720;const HOLIDAY_CACHE_TTL_MINUTES=720;const DEFAULT_COUNTRY_CODE="EG";const DEFAULT_CITY="Cairo";const DEFAULT_COUNTRY="Egypt";const OMNIAI_INTERNAL_URL="https://omniai-engine.ahmeddoba91.workers.dev/v1/chat/completions";const FAST_MODELS=[
{short:"G3.5-L",name:"Gemini 3.5 Flash-Lite",id:"gemini::gemini-3.5-flash-lite",timeoutMs:1800,tier:"easy",tags:["chat","shopping","schedule","json"]},
{short:"G3.5-F",name:"Gemini 3.5 Flash",id:"gemini::gemini-3.5-flash",timeoutMs:2200,tier:"easy",tags:["chat","shopping","schedule","analysis","json"]},
{short:"OSS20",name:"GPT OSS 20B — Groq",id:"groq::openai/gpt-oss-20b",timeoutMs:1700,tier:"easy",tags:["chat","shopping","schedule","coding","json"]},
{short:"Qwen3.6",name:"Qwen 3.6 27B — Groq",id:"groq::qwen/qwen3.6-27b",timeoutMs:1900,tier:"easy",tags:["chat","shopping","schedule","coding","vision","json"]},
{short:"Min3",name:"Ministral 3B",id:"mistral::ministral-3b-latest",timeoutMs:1700,tier:"easy",tags:["chat","shopping","json"]},
{short:"Min8",name:"Ministral 8B",id:"mistral::ministral-8b-latest",timeoutMs:1900,tier:"easy",tags:["chat","shopping","schedule","json"]},
{short:"MistralS",name:"Mistral Small 2603",id:"mistral::mistral-small-2603",timeoutMs:2200,tier:"easy",tags:["chat","shopping","schedule","coding","json"]},
{short:"DS-V4F",name:"DeepSeek V4 Flash — NVIDIA",id:"nvidia::deepseek-ai/deepseek-v4-flash",timeoutMs:2400,tier:"easy",tags:["chat","analysis","coding"]},
{short:"Step3.7",name:"Step 3.7 Flash — NVIDIA",id:"nvidia::stepfun-ai/step-3.7-flash",timeoutMs:2400,tier:"easy",tags:["chat","analysis","coding"]},
{short:"NemoNano",name:"Nemotron 3 Nano 30B A3B",id:"nvidia::nvidia/nemotron-3-nano-30b-a3b",timeoutMs:2400,tier:"easy",tags:["chat","analysis","coding"]}
];
