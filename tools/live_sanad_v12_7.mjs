...
const URL=process.env.URL,SETUP=process.env.SETUP_KEY;
if(!URL||!SETUP)throw new Error('missing V12.7 live URL/SETUP');
const deepRes=await fetch(`${URL}/selftest?v127=1`,{headers:{'X-Sanad-Key':SETUP}}),deep=await deepRes.json();
