/* SuperAgent V11.4 FULL — Google-only stable 3-model chain: Gemini 3.5 Flash-Lite primary, Gemini 3.1 Flash-Lite fallback 1, Gemini 3.6 Flash fallback 2. V11.3 reliability hardening retained; AI router remains removed. */
...
// Versioned identity.
handleV11Identity=async function(text,env,chatId){if(!isV11IdentityQuestion(text))return false;await sendText(env,chatId,'أنا سوبر إيجنت V11.4 🤖 — مساعدك الشخصي لتنظيم يومك ومواعيدك ومشترياتك وذاكرتك ومهامك من الكلام الطبيعي.');return true;};
