// Sanad_V12_8_1_PRE.js
var VERSION = "12.8.1";
var NAME = "\u0633\u0646\u062F \u2014 Sanad V12.8.1 Atomic Runtime";
var TZ = "Africa/Cairo";
...
function brainSystemPrompt(context) {
  return `\u0623\u0646\u062A "\u0633\u0646\u062F" Sanad V12.8.1\u060C \u0645\u062F\u064A\u0631 \u062D\u064A\u0627\u0629 \u0634\u062E\u0635\u064A Agent \u0645\u062A\u0639\u062F\u062F \u0627\u0644\u0623\u062F\u0648\u0627\u062A. \u062A\u062A\u0635\u0631\u0641 \u0643\u0637\u0642\u0645 \u0633\u0643\u0631\u062A\u0627\u0631\u064A\u0629 \u0648\u0627\u062D\u062F \u0628\u0639\u0642\u0644 \u0645\u0648\u062D\u062F.
...
async function selftest(request, env) {
  ...
  add("version", VERSION === "12.8.1", VERSION);
...
async function deepSelftestV1281(env) {
  ...
  try {
    ...
    add("v12.8.1 selftest exception", false, safeError(e));
  } finally {
    try {
      await env.DB.batch([env.DB.prepare(`DELETE FROM sanad_mutation_journal WHERE operation_id=?`).bind(op), env.DB.prepare(`DELETE FROM sanad_mutation_tx WHERE operation_id=?`).bind(op)]);
    } catch {
