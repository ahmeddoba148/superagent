/* SuperAgent V11.6 FINAL — zero VS Code/TypeScript diagnostics hardening over certified V11.5.2; runtime behavior and 3-model chain retained. */
/* SuperAgent V11.6 FINAL — fixed Google chain; V11.5.1 hardening retained; durable inbox lease-collision self-recovery, bounded contention wait, and strict direct-chat deadline; certified staging matrix. */
/* SuperAgent V11.6 FINAL — Google-only Lite-priority chain; stronger live-proven third fallback; V11.5 hardening retained; no AI router. */
/* SuperAgent V11.6 FULL — hardening over V11.4; Google Lite-priority 3-model chain; no AI router. */
...
// Versioned identity.
handleV11Identity=async function(text,env,chatId){if(!isV11IdentityQuestion(text))return false;await sendText(env,chatId,'أنا سوبر إيجنت V11.6 🤖 — مساعدك الشخصي لتنظيم يومك ومواعيدك ومشترياتك وذاكرتك ومهامك من الكلام الطبيعي.');return true;};
