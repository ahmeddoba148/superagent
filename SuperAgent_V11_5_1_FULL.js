/* SuperAgent V11.5.1 FINAL — Google-only Lite-priority chain; stronger live-proven third fallback; V11.5 hardening retained; no AI router. */
/* SuperAgent V11.5.1 FULL — hardening over V11.4; Google Lite-priority 3-model chain; no AI router. */
...
// Versioned identity.
handleV11Identity=async function(text,env,chatId){if(!isV11IdentityQuestion(text))return false;await sendText(env,chatId,'أنا سوبر إيجنت V11.5.1 🤖 — مساعدك الشخصي لتنظيم يومك ومواعيدك ومشترياتك وذاكرتك ومهامك من الكلام الطبيعي.');return true;};
